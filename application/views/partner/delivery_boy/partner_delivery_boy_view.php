        ...
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <div class="col-sm-6 text-right">
                    <a type="button" class="btn btn-info btn-xs" href="<?= base_url(); ?>admin/partner_delivery_boys"><i class="fa fa-backward"></i> BACK TO LIST</a>
                </div>
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
                                ...
                                <table class="table table-striped table-valign-middle" id="datatable1">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $delivery_boy_details->commissionType == 'PERCENTAGE' ? 'PERCENTAGE' : 'FIXED AMOUNT' ?></td>
                                        </tr>
                                        <tr>
                                            <td>Commission Amount?</td>
                                            <td><?= $delivery_boy_details->commissionAmount  ?></td>
                                        </tr>
                                        <tr>
                                            <td>Active?</td>
