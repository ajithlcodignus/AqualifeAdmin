                    ...
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-danger">
                            ...
                            <div class="inner">
                                ...
                                {
                                    ?>
                                    <a href="<?= base_url('admin/get_orders/Received') ?>"><h3><?php echo $pending_orders; ?></h3></a>
                                <?php
                                }
                                else {
                                    ?>
                    ...
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-info">
                            <div class="inner">
                                ...
                                {
                                    ?>
                                    <a href="<?= base_url('admin/get_orders/Assigned') ?>"><h3><?php echo $assigned_orders; ?></h3></a>
                                    <?php
                                }
                                else {
                                    ?>
                    ...
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-success">
                            <div class="inner">
                                ...
                                {
                                    ?>
                                    <a href="<?= base_url('admin/get_orders/Delivered') ?>"><h3><?php echo $completed_orders; ?></h3></a>
                                    <?php
                                }
                                else {
                                    ?>
