<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Publish APP Version</h1>
                </div><!-- /.col -->
                                ...
                                <table class="table table-striped table-valign-middle" id="datatable1">
                                    <tbody>
                                        <tr class="text-center">
                                            ...
                                            <td><button type="submit" class="btn btn-primary"  onclick="publish_app_change()" style="opacity: <?= $flag == 0 ? 0.5 : 1 ?>;">Publish Now</button></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
