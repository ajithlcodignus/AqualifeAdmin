...
<html lang="en">
    <head>
        ...
        <title><?= TAG_APP_NAME ?> | PUBLISH CHANGES </title>
...
//                        alert("Form successful submitted!");
            ...
            function publish_db_change()
            {
                ...
                if(publish_flag == 1)
                {
                    var res = confirm("Are you want to Publish Changes?");
                    if (res == true) {
                        $.post("<?= base_url(); ?>admin/publish_db_changes", function (data) {
                            if (data.length > 0) {
                                alert(data);
                ...
                {
                    alert("Please complete all the orders ans continue");
                }
            }


            function publish_app_change()
            {
                ...
                if(publish_flag == 1)
                {
                    var res = confirm("Are you want to Publish App Version?");
                    if (res == true) {
                        $.post("<?= base_url(); ?>admin/publish_app_version", function (data) {
                            if (data.length > 0) {
                                alert(data);
                                location.reload(true);
                            }
