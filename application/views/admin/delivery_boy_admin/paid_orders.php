<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Paid Orders</h1>
                </div><!-- /.col -->
                                        ...
                                        foreach ($pending_delivery_boys_list as $row) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <a class="btn btn-danger btn-xs"   href="javascript:void(0);" onclick="update_d_boy_payment_status(<?= $row->dbPaymentId; ?>,'NOT_PAID');"><i class="fa fa-times-circle mr-2" title="Not Paid"></i>NOT PAID</a>
