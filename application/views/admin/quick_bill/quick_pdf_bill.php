                ...
                <table style="width:100%">
                    ...
                    <tr style="text-align: center;width:100%">
                        ...
                        <td style="text-align: center; width:100%;padding-bottom:20px">
                            8113813659, 7736151724, 0495-2966624
                        </td>
                        <td></td>
                    ...
                    <table style="width: 100%;" class="item_table">
                        ...
                        ?>
                            <tr>
                                ...
                                <td class="item_table_td2" style="border-right:1px solid #000"><?php echo $row->quickItemName; ?></td>

                                <td class="item_table_td5" style="text-align: right;border-right:1px solid #000"><?php echo $row->quickQuantity; ?></td>
                                <td class="item_table_td6" style="text-align: right;border-right:1px solid #000"><?php echo number_format($row->quickAmount,2);  ?></td>
                        ...
                        <tr>
                            ...
                            <th class="item_table_top_border item_table_td7" style="text-align: right;border-top:1px solid #000"><?= number_format($quick_output['current_order_details']["deliveryFee"],2) ?></th>
                        <tr>
                            <td class="item_table_top_border item_table_td1"></td>
                            ...
                            <td class="item_table_top_border item_table_td5"></td>
                            <td class="item_table_top_border item_table_td6"></td>
                            <th class="item_table_top_border item_table_td7" style="text-align: right"><?= number_format($quick_output['current_order_details']["gst"],2) ?></th>
                        ...
                        <tr style="border-top: 1px solid #000;">
                            ...
                            <td class="item_table_top_border item_table_td6"></td>
                            <th class="item_table_top_border item_table_td7" style="text-align: right"><?= number_format( ($total_item_amount + $quick_output['current_order_details']["deliveryFee"] + $quick_output['current_order_details']["gst"]),2) ?></th>
                        </tr>
