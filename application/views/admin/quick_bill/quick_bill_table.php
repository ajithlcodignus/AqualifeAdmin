        ...
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <div class="col-sm-6 text-right">
                    <form role="form" method="post" action="<?= base_url('admin/quick_bill_list_status');?>" id="quickForm">
                        <div>
                            <select class="form-control" name="orderSummary" id="orderSummary" style="width:auto; display:inline">
