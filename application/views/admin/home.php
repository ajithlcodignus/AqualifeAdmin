                        ...
                        <div class="col-lg-3 col-6">
                            ...
                            <div class="small-box bg-warning">
                                <div class="inner">
                                    ...
                                    ?>
                                        <a href="<?= base_url('admin/get_orders/Cancelled') ?>">
                                ...
                                <a href="<?= base_url('admin/get_orders/Cancelled') ?>" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                    </div>
            </section>
                                    ...
                                    ?>
                                        ...
                                        <table class="table table-striped table-valign-middle" id="datatable1">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                        <tr>
                                                            <td><a href="<?php echo base_url('admin/shop_select/' . $row->shopId . '?shop_name=' . $row->name); ?>"><?php echo $row->name; ?></a></td>
