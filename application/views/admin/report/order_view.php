        ...
        <div class="row">
            <table style="width: 100%;border: 1px solid;border-collapse: collapse;">
                ...
                <tr>
                    ...
                    <th style="border: 1px solid;text-align: center;">Shop</th>
                ...
                if (!empty($result)) {
                    ...
                    foreach ($result as $val) {
                        ...
                        <tr>
                            ...
                            <td style="border: 1px solid;text-align: center; width:90px;"><?= date('d-m-Y', strtotime($val->orderDate)); ?></td>
                            <td style="border: 1px solid;text-align: center;"><?= $val->shopName; ?></td>
