...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">ADD SHOP CATEGORY </h1>
                </div><!-- /.col -->
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <form role="form" method="post" action="<?= base_url('admin/insert_shop_category'); ?>" id="quickForm" enctype="multipart/form-data">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <label>Status</label>
                                        <select class="form-control" name="shopCategoryStatus" style="width: 100%;" required="">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="shopCategory">Priority</label>
                                            <input type="text" name="priority" id="priority" value="<?= $priority ?>" class="form-control" required="" />
                                        </div>
                                    </div>
                                </div>
                            </div>
