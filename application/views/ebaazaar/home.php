                            ...
                            <div class="card-body table-responsive p-0">
                                <table class="table table-striped table-valign-middle">
                                    ...
                                    <?php foreach ($shop_list as $row) {
                                        ?>
                                        <tr>
                                            <td><a href="<?php echo base_url('ebadmin/shop_select/' . $row->shopId . '/' . $row->name); ?>"><?php echo $row->name; ?></a></td>
                                            ...
                                            <td>
                                                ...
                                                {
                                                    ?>
                                                <a href="<?= base_url('ebadmin/get_orders/Received/'.$row->shopId) ?>"><h3><?php echo $row->newOrder; ?></h3></a></td>
                                                <?php
                                                }
                                                else
                                                {
