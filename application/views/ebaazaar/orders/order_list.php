                            ...
                            foreach ($orders_list as $row) {
                                ...
                                <tr>
                                    ...
                                    <td class="project-actions text-right">
                                        <a class="btn btn-primary btn-sm" href="<?php echo base_url() ?>ebadmin/order_full_view?orderId=<?php echo $row->orderId; ?>">
                                            <i class="fa fa-eye">
                                            </i>
                                        </a>
                                        <?php if($row->orderStatus == "Received")
                                        {
                                            ?>
                                            <a class="btn btn-info btn-sm" href="<?php echo base_url() ?>ebadmin/delivery_boy_list_order_assign?orderId=<?php echo $row->orderId; ?>">
                                                <i class="fa fa-plus">
                                                </i>
                                            </a>
                                        <?php
