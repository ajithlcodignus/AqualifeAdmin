        ...
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <div class="col-sm-6 text-right">
                    <a type="button" class="btn btn-info btn-xs" href="<?= base_url(); ?>admin/delivery_boy"><i class="fa fa-backward"></i> BACK TO LIST</a>
                </div>
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <form role="form" method="post" action="<?= base_url('admin/update_delivery_boy'); ?>" id="quickForm">
                            <div class="card-body">
                                <input type="hidden" name="deliveryBoyId" value="<?= $delivery_boy_details->deliveryBoyId ?>"/>
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="mobile" class="form-control" value="<?= $delivery_boy_details->mobile; ?>" required="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="emailId" class="form-control" value="<?= $delivery_boy_details->emailId ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="active" style="width: 100%;" required="">
                                                <option value="0" <?= $delivery_boy_details->active == 1 ? 'selected' : ''; ?>>Active</option>
                                                <option value="1" <?= $delivery_boy_details->active == 0 ? 'selected' : ''; ?>>In Active</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="place" class="form-control" value="<?= $delivery_boy_details->address ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <textarea name="address" class="form-control" rows="2"><?= $delivery_boy_details->place ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
