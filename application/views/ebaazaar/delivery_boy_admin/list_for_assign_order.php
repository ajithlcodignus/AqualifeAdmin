                            ...
                            <div class="col-md-3">
                                ...
                                <div class="card card-primary card-outline">
                                    <div class="card-body box-profile">
                                        ...
                                        {
                                            ?>
                                            <a href="<?php echo base_url() ?>ebadmin/assign_order?orderId=<?php echo $orderId; ?>&deliveryBoyId=<?php echo $row->deliveryBoyId; ?>" class="btn btn-primary btn-block"><b>Assign</b></a>
                                            <?php
                                        }
                                        else {
                                            ?>
                                            <a href="<?php echo base_url() ?>ebadmin/add_shop_delivery_boy?deliveryBoyId=<?php echo $row->deliveryBoyId; ?>" class="btn btn-primary btn-block"><b>Add</b></a>
                                            <?php
                                        }?>
