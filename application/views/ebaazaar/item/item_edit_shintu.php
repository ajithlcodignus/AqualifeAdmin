                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Shop</label>
                                            <select class="form-control select2" name="shopId" style="width: 100%;" required="">
                                                <?php
                                                if (count($shop)) {
                                                    foreach ($shop as $val) {
                                                        ?>
                                            ...
                                            <select class="form-control select2" name="categoryId" style="width: 100%;" required="" onchange="load_sub_category(this.value);">
                                                ...
                                                if (count($category)) {
                                                    foreach ($category as $val) {
                                                        ?>
                                                        <option value="<?= $val->categoryId; ?>" <?= $item[0]->categoryId == $val->categoryId ? 'selected' : ''; ?>><?= $val->categoryName; ?></option>
                                                        <?php
                                                    }
                                                }
                                                ?>
                                            ...
                                            <select class="form-control select2" name="subCategoryId" style="width: 100%;">
                                                ...
                                                if (count($sub_category)) {
                                                    foreach ($sub_category as $val) {
                                                        ?>
                                                        <option value="<?= $val->suCategoryId; ?>" <?= $item[0]->subCategoryId == $val->suCategoryId ? 'selected' : ''; ?>><?= $val->name; ?></option>
                                                        <?php
                                                    }
                                                }
                                                ?>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" class="form-control" value="<?= $item[0]->name; ?>" required="">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="availabilityStatus" style="width: 100%;" required="">
                                                <option value="0" <?= $item[0]->availabilityStatus == 0 ? 'selected' : ''; ?>>Available</option>
                                                <option value="1" <?= $item[0]->availabilityStatus == 1 ? 'selected' : ''; ?>>Not Available</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-4" id="best_item_image_div" style="<?= $item[0]->bestItemFlag == 0 ? 'display: none' : 'display: block'; ?>">
                                        ...
                                        <?php if ($item[0]->bestItemImage) { ?>
                                            <img src="<?= base_url() . $item[0]->bestItemImage; ?>" style="width: 10%;">
                                        <?php } ?>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                        ...
                                        <?php if ($item[0]->image) { ?>
                                            <img src="<?= base_url() . $item[0]->image; ?>" style="width: 10%;">
                                        <?php } ?>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <textarea name="description" class="form-control" rows="2"><?= $item[0]->description; ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
