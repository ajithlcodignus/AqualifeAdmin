        ...
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <div class="col-sm-6 text-right">
                    ...
                    <a type="button" class="btn btn-success btn-xs" href="<?/*= base_url(); */?>QuickerShoppy/add_items"><i class="fa fa-plus"></i> ITEM</a>-->
                </div>
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
                                        ...
                                        foreach ($item as $row) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a class="btn btn-primary btn-xs" href="<?= base_url('ebadmin/item_view/' . $row->itemId); ?>" ><i class="fa fa-book" title="Full View"></i></a>
