<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            <h4 class="modal-title">IMPORT ITEM DETAILS</h4>
            <a type="button" class="close" href="<?= base_url('admin/item');?>" style="margin: -6px;">
        ...
        <form role="form" method="post" action="<?= base_url('admin/insert_import_item'); ?>" enctype="multipart/form-data" id="ImportItemForm">
            ...
            <div class="modal-footer justify-content-between">
                <a type="button" class="btn btn-default" href="<?= base_url('admin/item');?>">Close</a>
            </div>
        </form>
    </div>
    <!-- /.modal-content -->
